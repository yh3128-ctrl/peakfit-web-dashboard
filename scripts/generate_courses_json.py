...
TARGET_FILES = [
    ...
    '유명산_0000000006.gpx',   # 경기 가평, POI 19개 (_003은 정상서 끊김→_006으로 교체)
    ...
    '재약산_0000000006.gpx',   # 경남 밀양, POI 14개 (_009는 정상서 끊김→_006으로 교체, 정상1211m)
    ...
    '백운산(광양)_0000000004.gpx',  # 전남 광양, POI 45개 (_007 end=938m→_004 end=374m)
    ...
    '마이산_0000000004.gpx',   # 전북 진안, POI 18개 (_001 end=447m→_004 end=300m, 원점회귀)
    '소백산_0000000006.gpx',   # 충북·경북, POI 15개 (_001 end=1429m 정상서 끊김→_006 end=416m)
